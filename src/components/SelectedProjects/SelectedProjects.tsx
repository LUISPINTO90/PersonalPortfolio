    ...
    <Card className="w-full mt-8 max-w-7xl">
      ...
      <div className="w-full pt-6 p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative">
          ...
          {/* One blurred project for small screens */}
          <div className="block md:hidden">
            <Card className="opacity-30 blur-sm">
              <div className="p-4 space-y-4 h-full flex flex-col">
                <div className="flex-grow">
                  <Image
                    src={projects[2].profilePhoto}
          ...
          {/* Two blurred projects for medium screens */}
          {projects.slice(2, 4).map((project) => (
            <div key={project.slug} className="hidden md:block lg:hidden">
              <Card className="opacity-30 blur-sm">
                <div className="p-4 space-y-4 h-full flex flex-col">
                  <div className="flex-grow">
                    <Image
